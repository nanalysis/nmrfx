...
import org.nmrfx.structure.seqassign.SeqGenParameters;
import org.nmrfx.structure.seqassign.SeqGeneticAlgorithm;
...
public class GraphMatcherGUI {
    ...
    SimpleIntegerProperty multiMaxProp = new SimpleIntegerProperty(200);
    ...
    public GraphMatcherGUI(RunAboutGUI runAboutGUI, ResSeqMatcher resSeqMatcher, RunAbout runAbout) {
    ...
    Pane makeParPane() {
        ...
        gridPane.add(new Label("N Initial"),0, row);
        gridPane.add(GUIUtils.getIntegerTextField(multiMaxProp), 1, row++);
    ...
    void bipartiteAnalyze() {
        ...
        resSeqMatcher.compareMatrix(runAbout.getSpinSystems());
            ...
            SeqGenParameters seqGenParameters = new SeqGenParameters(popSizeProp.get(), nGenProp.get(),
                    mutationRateProp.get(),crossOverRateProp.get(),eliteNumberProp.get(),maxPhenoTypeAgeProp.get(),
                    steadyLimitProp.get(), multiMaxProp.get());
