...
public class PeakSlider implements ControllerTool {
    ...
    public void initSlider(ToolBar toolBar) {
        ...
        atomXLabel.setMinWidth(60);
        atomYLabel = new Label();
        atomYLabel.setMinWidth(60);
        intensityLabel = new Label();
        intensityLabel.setMinWidth(60);
        ...
        filler2.setMinWidth(40);
        Pane filler3 = new Pane();
        filler3.setMinWidth(40);
        Pane filler4 = new Pane();
        filler4.setMinWidth(40);
        ...
        if (toolBar != null) {
            ...
            toolBar.heightProperty().addListener((observable, oldValue, newValue) -> {
                List<Node> items = Arrays.asList(closeButton, actionMenu, atomXFieldLabel, atomXLabel, atomYFieldLabel, atomYLabel, intensityFieldLabel, intensityLabel);
...
//    }
    ...
    void alignPeakList(PeakList predHMQCList, PeakList expHMQCList,
        ...
        try {
            ...
            for (FXMLController controller : FXMLController.getControllers()) {
                controller.redrawChildren();
            }
        }
    }
