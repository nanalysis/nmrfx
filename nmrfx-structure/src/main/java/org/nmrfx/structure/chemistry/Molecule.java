...
import java.util.*;
        ...
        public class Molecule extends MoleculeBase {
            private static final Logger log = LoggerFactory.getLogger(org.nmrfx.structure.chemistry.Molecule.class);
     ...
     colorTypes.add("gproperty");
         */
            ...
            public static org.nmrfx.structure.chemistry.Molecule getActive() {
                return (org.nmrfx.structure.chemistry.Molecule) MoleculeFactory.getActive();
            }
            ...
            public static org.nmrfx.structure.chemistry.Molecule get(String name) {
                if (name == null) {
                    return null;
                } else {
                    return (org.nmrfx.structure.chemistry.Molecule) MoleculeFactory.getMolecule(name);
                }
            }
...
//        RealMatrix rotMat = rdcEig.getVT().copy();
                ...
                for (int k = 0; k < n; k++) {
                    ...
                    if (selected > 0) {
                        ...
                        if (ptB != null) {
                            ...
                            if ((spatialSet1 == spatialSet2) || (org.nmrfx.structure.chemistry.Molecule.selCycleCount == 0) || ((k + 1) >= n)
                                    || ((org.nmrfx.structure.chemistry.Molecule.selCycleCount != 1) && (((k + 1) % org.nmrfx.structure.chemistry.Molecule.selCycleCount) == 0))) {
                                coords[i++] = (float) ptB.getX();
                                coords[i++] = (float) ptB.getY();
                                coords[i++] = (float) ptB.getZ();
            ...
            public static List<Bond> matchBonds() throws IllegalArgumentException {
                ...
                Atom atomB;
                Atom atomE;
                org.nmrfx.structure.chemistry.Molecule molecule = (org.nmrfx.structure.chemistry.Molecule) MoleculeFactory.getActive();
     ...
     *
         */
            ...
            public static Atom getStartAtom(org.nmrfx.structure.chemistry.Molecule molecule) {
            ...
            public static int buildTree(org.nmrfx.structure.chemistry.Molecule molecule, Atom startAtom, List<Atom> atomList, MTree mTree) {
