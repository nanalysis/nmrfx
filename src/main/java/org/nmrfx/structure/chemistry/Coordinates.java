...
class Coordinates {
    ...
    Coordinates(Point3 p1, Point3 p2, Point3 p3) {
        this.p1 = p1;
        this.p2 = p2;
        this.p3 = p3;
    }
 ...
 /*
    ...
    Point3 calculate(final double dihedral, final double bndcos, final double bndsin) {
         ...
         */
        Point3 p4 = new Point3(p3.getX() + cdx, p3.getY() + cdy, p3.getZ() + cdz);
        return p4;
    }
}
