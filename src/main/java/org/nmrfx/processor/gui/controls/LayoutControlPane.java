 ...
 */
public class LayoutControlPane extends Pane {

    final FractionPane fPane;
    Rectangle lastRect = null;
    StackPane movingRect = FXMLController.makeNewWinIcon();

    public LayoutControlPane(FractionPane fPane) {
        this.fPane = fPane;
    ...
    public void layoutChildren() {
        ...
        } else if (fPane.orient == FractionPane.ORIENTATION.HORIZONTAL) {
            rects[0].setVisible(true);
            rects[1].setVisible(true);
            rects[2].setVisible(false);
            rects[3].setVisible(false);
        } else if (fPane.orient == FractionPane.ORIENTATION.VERTICAL) {
